...
public class TextScan {
    ...
    public static LinkedList generateTokens(String fileName){ //function by turnq070 inspired by code from main
        LinkedList returnList = new LinkedList(); //LinkedList by turnq070, modified for this project
        Scanner readFile = null;
        String s;
        int count = 0;
        try {

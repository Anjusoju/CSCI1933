...
public class Triangle {
    ...
    double height;
    Color color;
    public Triangle(double initXPosition, double initYPosition, double initWidth, double initHeight){
    ...
    //     Triangle triguy = new Triangle(0.0, 0.0, 2.0, 2.0);
    //     System.out.println(triguy.calculateArea());
    // }
}
